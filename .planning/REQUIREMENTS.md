...
- [x] **UI-02**: Difficulty modal on game entry (Easy/Medium/Hard)
- [x] **UI-03**: Grid renders with black cells, white cells, and superscript cell numbers
- [x] **UI-04**: Tap cell selects it and highlights full word in that direction
- [x] **UI-05**: Tap already-selected cell toggles between Across and Down
- [x] **UI-06**: Tap clue jumps to first empty cell of that word
- [x] **UI-07**: Hidden input for letter entry with auto-advance to next empty cell in word
- [x] **UI-08**: Correct word flashes green, locks cells, plays word_found sound
- [x] **UI-09**: Puzzle complete triggers congratulations modal and board_finished sound
- [x] **UI-10**: Stats recorded via Settings.recordWin('kruiswoord', timeSeconds)
- [x] **UI-11**: Back button returns to welcome screen with confirmation if puzzle in progress
